...
<html>
<head>
    <title>Melhor Resultado de Treino</title>
    <style>
...
<body>
    <h2> Melhor Resultado de Treino</h2>
    <form method="post">
        ...
        <textarea name="alunos" placeholder='Ex: 
{
    ...
    "Carlos": [40, 42, 45]
        ...
        <button type="submit">Encontrar Melhores Resultados</button>
    </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($registrosTreino) {
            ...
            echo "<table>";
            echo "<tr><th>Aluno</th><th>Sessões de Treino</th><th>Melhor Resultado</th></tr>";
